...
class MLPFQRForecastModel(BaseForecastModel):
    def __init__(
        self,
        data_pipeline=None,
        ...
        Args:
            ...
            N (int, optional): Parameter N. Defaults to 90.
            eps (float, optional): Small constant to prevent division by zero. Defaults to 1e-6.
            kappa (float, optional): Parameter kappa. Defaults to 0.25.
        ...
        self.model = MLPFQRForecastNetwork(
...
class MLPQRForecastModel(BaseForecastModel):
    def __init__(
        self,
        data_pipeline=None,
        target_series: list[str] | str = ["NetLoad"],
        ...
        """
        Initialize the Multilayer Perceptron (MLP) Quantile Regression Forecast Model for time series forecasting.
        ...
        Args:
            ...
            alpha (float, optional): Alpha parameter for the loss function. Defaults to 0.1.
            num_attention_heads (int, optional): Number of attention heads. Defaults to 4.
            quantiles (list[float], optional): List of quantiles for quantile regression. Defaults to [0.05, 0.25, 0.75, 0.95].
            eps (float, optional): Small constant to prevent division by zero. Defaults to 1e-6.
            kappa (float, optional): Parameter kappa. Defaults to 0.25.
            metric (str, optional): Metric for evaluation. Defaults to "mae".
            learning_rate (float, optional): Learning rate for the optimizer. Defaults to 1e-3.
        ...
        Example:
            ...
            model = MLPQRForecastModel(**kwargs)
        """
        super().__init__(data_pipeline, metric)
        ...
        self.model = MLPQRForecastNetwork(
            n_target_series=self.n_out,
            n_unknown_features=len(unknown_features),
            n_known_calendar_features=len(known_calendar_features),
            n_known_continuous_features=len(known_continuous_features),
