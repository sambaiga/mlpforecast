...
from  xgboost import XGBRegressor, XG
...
class CatBoostModel(BaseRegressor):
    ...
    def get_catboost_search_params(self, trial):
        params = {}
...
class XGBModel(BaseRegressor):
    ...
    def get_xgboost_search_params(self, trial):
...
class LightGBMModel(BaseRegressor):
    ...
    def get_lgbm_search_params(self, trial):
