    ...
    def get_search_params(self, trial: Trial) -> dict:
        ...
        params["stack_types"]=trial.suggest_categorical(
                "stack_types", [['identity', 'trend', 'seasonality'], 
                                ...
                                ['trend', 'seasonality'] ])
        params["mlp_units"] = [trial.suggest_categorical("mlp_units", [32, 64, 128, 256, 512])]*len(params["stack_types"])

        params["n_blocks"]=[trial.suggest_int('n_blocks', 1, 4)]*len(params["stack_types"])
