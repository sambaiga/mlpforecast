...
from mlpforecast.net.mlpf import MLPForecastNetwork, ACTIVATIONS
...
class MLPForecastModel(BaseForecastModel):
    ...
    def get_search_params(self, trial: Trial) -> dict:
        ...
        params["alpha"] = trial.suggest_float("alpha", 0.01, 0.9)
