from neuralforecast.models.nbeats import  TrendBasis, IdentityBasis, SeasonalityBasis, NBEATSBlock
            ...
            for block_id in range(n_blocks[i]):
                ...
                if shared_weights and block_id > 0:
                    ...
                    if stack_types[i] == "seasonality":
                        ...
                        n_theta = input_size + self.n_out * h
                        basis = IdentityBasis(
                            backcast_size=input_size,
                            forecast_size=h,
                            out_features=self.n_out,
