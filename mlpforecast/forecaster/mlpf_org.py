...
from mlpforecast.model.mlpfOG import MLPForecastModelOG

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger("MLPF")


class MLPForecastOG(PytorchForecast):
    """
    ...
    def __init__(
        ...
        self.model = MLPForecastModelOG(**hparams)
    ...
    def load_checkpoint(self):
        ...
        #self.model = MLPForecastModelOG.load_from_checkpoint(path_best_model)
        self.model.eval()
    ...
    def auto_tune(self, train_df, val_df, num_trial=10, reduction_factor=3, patience=2):
        ...
        self.hparams['hparams'].update(study.best_trial.params)
