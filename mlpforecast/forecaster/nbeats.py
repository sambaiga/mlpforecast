...
from mlpforecast.model.nbeats import NBEATSForecastModel
logging.basicConfig(level=logging.INFO)
logger = logging.getLogger("NBEATSForecast")


class NBEATSForecast(PytorchForecast):
    """
    ...
    def __init__(
        ...
        self.model = NBEATSForecastModel(**hparams)
    ...
    def load_checkpoint(self):
        ...
        self.model = NBEATSForecastModel.load_from_checkpoint(path_best_model)
        self.model.eval()
