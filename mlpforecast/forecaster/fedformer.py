...
from mlpforecast.model.fedformer import FeDformerForecastModel
logging.basicConfig(level=logging.INFO)
logger = logging.getLogger("FeDformerForecast")


class FeDformerForecast(PytorchForecast):
    """
    ...
    def __init__(
        ...
        self.model = FeDformerForecastModel(**hparams)
    ...
    def load_checkpoint(self):
        ...
        self.model = FeDformerForecastModel.load_from_checkpoint(path_best_model)
        self.model.eval()
